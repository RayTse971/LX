...
个人简介 / About Me
------
现任东南大学网络空间安全学院副研究员，曾入选教育部博士后海外引才专项计划和东南大学-华为“紫金青年学者”，主持国家自然科学基金青年项目和江苏省自然科学基金青年项目等。主要研究方向包括通信感知一体化、无线通信、雷达信号处理、优化理论和深度学习等。在IEEE JSAC、IEEE TWC、IEEE TGRS、IEEE TAES、IEEE WCM、IEEE CL、Elsevier SP、IEEE ICC 和IEEE IGARSS 等相关领域顶级期刊和顶级会议发表与本项目相关的学术论文26篇，其中以第一作者身份发表论文15篇。多次担任IEEE JSAC、IEEE TSP、IEEE JSTSP、IEEE TWC、IEEE TCOM、IEEE TGRS、IEEE TAES、IEEE TVT、IEEE JSTAR和IEEE IOTJ等期刊审稿人。担任2026 IEEE International Conference on Communications (ICC2026), 2025 IEEE 102nd Vehicular Technology Conference (VTC2025-Fall)的TPC成员。
